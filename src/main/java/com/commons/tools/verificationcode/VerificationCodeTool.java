...
public class VerificationCodeTool {  
    //LOG  
    private static final Logger LOG = LoggerFactory.getLogger("VerificationCodeTool");
    //verification code image width  
    private int IMG_WIDTH=146;  
    //verification code image height  
    private int IMG_HEIGHT=30;  
    //The number of interference lines  
    private int DISTURB_LINE_SIZE = 15;  
...
//              suChinese.append(CNUMBERS[yy]);  
    ...
    public static void main(String[] args) throws IOException{
    	...
    	BufferedImage bi = vct.drawVerificationCodeImage();
    	ImageIO.write(bi, "jpeg", new File("d:/dd3d"));
    }
}  
